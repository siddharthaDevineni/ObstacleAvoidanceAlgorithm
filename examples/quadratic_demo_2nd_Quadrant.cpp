...
int main(int argc, char *argv[])
{
    ...
    float obstaclex[nObstaclesTotal] = {-4, -6};    // {obs1_x1, obs2_x1, obs3_x1}
    float obstacley[nObstaclesTotal] = {2.5, 5};    // {obs1_y1, obs2_y1, obs3_y1}
    float xObstacleEnd[nObstaclesTotal] = {-2, -8}; // {obs1_x2, obs2_x2, obs3_x2}
    float yObstacleEnd[nObstaclesTotal] = {5, 8};   // {obs1_y2, obs2_y2, obs3_y2}
